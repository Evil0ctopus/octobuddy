...
Tap your buddy to boost mood, feed when hungry, and watch a gentle idle bob while Hunger and Mood drift over time (local-only, DataStore).
...
- Tap pet → mood boost · **Feed** button → hunger (and a little mood)
- Friendly status copy (“OctoBuddy is happy / hungry / sleepy …”)
